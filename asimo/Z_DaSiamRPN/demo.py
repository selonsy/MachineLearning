...
model_path = [
    ...
    'D:\\workspace\\vot\\asimo\\other\\DaSiamRPN\\selonsy\\model\\SiamRPNOTB.model',
    'D:\\workspace\\vot\\asimo\\other\\DaSiamRPN\\selonsy\\model\\SiamRPNVOT.model'
    ]
...
# image and init box
image_files = sorted(glob.glob(r'D:\workspace\vot\otb\2016\basketball\*.jpg'))
